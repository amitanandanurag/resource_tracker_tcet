...
echo "<script> console.log('currentUserId : ' + " . json_encode($currentUserId) . " + ' currentRoleId : ' + " . json_encode($currentRoleId) . "); </script>";
      ...
      <div class="box profile-form-card">
        ...
        <div class="box-body" style="padding-bottom:0;">
          <p style="margin-bottom:10px; color:#374151; font-weight:600;">
            User: <?php echo htmlspecialchars($passwordData['username']); ?>
          </p>

          <p style="margin-bottom:0; color:#6b7280;">
            Role: <?php echo htmlspecialchars($passwordData['role_name']); ?>
          </p>
        </div>
        ...
        <form class="form-horizontal" method="POST">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                ...
                <div class="input-group profile-input-group">
                  ...
                  <input
                    type="password"
                    class="form-control password-toggle-field"
                    id="current_password"
          ...
          <div class="box-footer">
            ...
            <button type="submit" class="pull-right profile-save-btn">
