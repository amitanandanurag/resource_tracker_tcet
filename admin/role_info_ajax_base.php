...
$baseSql = "SELECT u.user_id, u.user_name, u.email_id, u.phone_number, d.department_name, r.role_name FROM rt_user_master u LEFT JOIN rt_department_master d ON d.department_id = u.department_id LEFT JOIN rt_role_master r ON r.role_id = u.role_id WHERE u.role_id = " . intval($roleId);
